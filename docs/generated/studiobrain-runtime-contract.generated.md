...
## Sources
- Schema: `D:\monsoonfire-portal-studiobrain-deploy\studio-brain\.env.contract.schema.json`
- Network profile: `D:\monsoonfire-portal-studiobrain-deploy\studio-brain\.env.network.profile`

## Contract Summary
- Schema version: `1.0.0`
- Variables tracked: `120`
- Required variables: `15`
- Optional variables: `105`
- Sensitive variables (redacted defaults): `8`
...
| STUDIO_BRAIN_BASE_URL | string | no |  |
...
| STUDIO_BRAIN_ENABLE_PROJECTION_MAINTENANCE | boolean | no | false |
...
| STUDIO_BRAIN_MEMORY_INGEST_ALLOWED_DISCORD_CHANNEL_IDS | string | no |  |
| STUDIO_BRAIN_MEMORY_INGEST_ALLOWED_DISCORD_GUILD_IDS | string | no |  |
| STUDIO_BRAIN_MEMORY_INGEST_ALLOWED_SOURCES | string | no |  |
| STUDIO_BRAIN_MEMORY_INGEST_ENABLED | boolean | no | false |
| STUDIO_BRAIN_MEMORY_INGEST_HMAC_SECRET | string | no | (redacted) |
| STUDIO_BRAIN_MEMORY_INGEST_MAX_SKEW_SECONDS | integer | no | 300 |
| STUDIO_BRAIN_MEMORY_INGEST_REQUIRE_CLIENT_REQUEST_ID | boolean | no | true |
| STUDIO_BRAIN_MEMORY_STATS_ROLLUP_STALE_MS | integer | no | 60000 |
| STUDIO_BRAIN_MIGRATIONS_STRICT | boolean | no | false |
| STUDIO_BRAIN_MINIO_BIND_HOST | string | no | 127.0.0.1 |
...
| STUDIO_BRAIN_OTEL_BIND_HOST | string | no | 127.0.0.1 |
...
| STUDIO_BRAIN_PG_STATEMENT_TIMEOUT_MS | integer | no | 30000 |
| STUDIO_BRAIN_PORT | integer | yes | 8787 |
| STUDIO_BRAIN_POSTGRES_BIND_HOST | string | no | 127.0.0.1 |
| STUDIO_BRAIN_PROJECTION_MAINTENANCE_INTERVAL_MS | integer | no | 900000 |
| STUDIO_BRAIN_PROJECTION_SIGNAL_REBUILD_LIMIT | integer | no | 1000 |
| STUDIO_BRAIN_PROJECTION_SIGNAL_REBUILD_MAX_WRITES | integer | no | 1000 |
| STUDIO_BRAIN_PROJECTION_SIGNAL_REBUILD_WRITE_DELAY_MS | integer | no | 0 |
| STUDIO_BRAIN_PUBLIC_HOST | string | no |  |
| STUDIO_BRAIN_PUBLIC_HTTPS_PORT | integer | no | 443 |
| STUDIO_BRAIN_PUBLIC_HTTP_PORT | integer | no | 80 |
| STUDIO_BRAIN_PUBLIC_UPSTREAM | string | no |  |
| STUDIO_BRAIN_READY_MAX_SNAPSHOT_AGE_MINUTES | integer | no | 240 |
| STUDIO_BRAIN_REDIS_BIND_HOST | string | no | 127.0.0.1 |
...
| STUDIO_BRAIN_RETENTION_DERIVED_REBUILD_WINDOW_DAYS | integer | no | 30 |
| STUDIO_BRAIN_RETENTION_DURABLE_MEMORY_DAYS | integer | no | 180 |
| STUDIO_BRAIN_RETENTION_LOOP_EVENT_DAYS | integer | no | 30 |
| STUDIO_BRAIN_RETENTION_MEMORY_TELEMETRY_DAYS | integer | no | 30 |
| STUDIO_BRAIN_RETENTION_OPERATIONAL_DAYS | integer | no | 180 |
| STUDIO_BRAIN_SCAN_LIMIT | integer | no | 2000 |
| STUDIO_BRAIN_SEMANTIC_MODE | string | no |  |
...
Source digest: `94d334db34b46c1e5a7ca106c5ebbba39b60ed6a89fa4c1c6be4eb29381bcbe6`
