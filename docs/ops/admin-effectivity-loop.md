...
Artifact validation reads its default catalog from `scripts/ops/artifact_registry.mjs`; add new latest-artifact contracts there first, then let validators and downstream reports consume the shared registry.
