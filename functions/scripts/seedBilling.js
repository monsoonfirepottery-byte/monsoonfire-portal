...
const charges = [
  {
    ...
    doc: {
      ...
      receiptUrl: "https://stripe.com/receipt/sample-event",
      createdAt: now,
      updatedAt: now,
      paidAt: now,
    },
...
const materials = [
  {
    ...
    doc: {
      ...
      checkoutUrl: "https://checkout.stripe.com/c/pay/cs_test_billing_pending",
      receiptUrl: null,
  ...
  },
  {
    ...
    doc: {
      ...
      checkoutUrl: null,
      receiptUrl: "https://stripe.com/receipt/sample-materials",
      pickupNotes: null,
      createdAt: now,
      updatedAt: now,
      paidAt: now,
