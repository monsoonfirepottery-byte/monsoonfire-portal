...
- generatedAtUtc: 2026-02-17T20:09:30.3467164Z
...
| --- | --- | --- | --- | ---: |
| Reddit Local Commercial Signals | community_signal | ok | local | 44 |
| Meta Marketplace Community Signals | community_signal | ok | local | 1 |
| Grants.gov Opportunities | grant_program | ok | local | 12 |
| Arizona Commerce Grants and Incentives | grant_program | ok | local | 1 |
| City of Phoenix Business Grants Programs | grant_program | ok | local | 1 |
| SBA Grants and Funding Programs | grant_program | ok | local | 2 |
| Arizona State Surplus Property Auctions | government_auction | ok | local | 2 |
| Maricopa Local Surplus Property Auctions | government_auction | ok | local | 1 |
| Federal Real Property Disposals and Auctions | government_auction | ok | local | 15 |
| Maricopa Treasurer Delinquent Roll | government_tax | ok | local | 31 |
| Maricopa Recorder Trustee and Legal Notices | government_legal | ok | local | 2 |
...
| Maricopa Assessor Ownership History | government_data | ok | local | 500 |
...
| Environmental and Land-Use Constraints | regulatory_data | ok | local | 1 |
