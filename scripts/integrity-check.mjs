...
const DEFAULT_TARGET_FILES = [
  ...
  "scripts/ops/backup_postgres_artifact_verifier.sh",
  "scripts/ops/backup_restore_prerequisite_drill.sh",
  "scripts/ops/docker_inventory.sh",
  "scripts/ops/docker_posture_review.sh",
  "scripts/ops/effectivity_report.sh",
  "scripts/ops/host_failed_unit_trends.sh",
  "scripts/ops/host_package_posture.sh",
  "scripts/ops/incident_bundle_v2.sh",
  "scripts/ops/ops_ci_validate.sh",
  "scripts/ops/post_deploy_verify.sh",
  ...
  "scripts/ops/postgres_query_hotspot_issue_generator.sql",
  "scripts/ops/postgres_readonly_review.sql",
  "scripts/ops/postgres_roles_extensions_security_packet.sql",
  "scripts/ops/redis_minio_evidence_verifier.sh",
  "scripts/ops/time_sync_posture.sh",
  ...
  "config/studiobrain/systemd/studio-brain-idle-worker.service",
  "config/studiobrain/systemd/studio-brain-idle-worker.service.d/10-readonly-depth.conf",
  "config/studiobrain/systemd/studio-brain-idle-worker.service.d/20-clean-lane.conf",
  "config/studiobrain/systemd/studio-brain-idle-worker.timer",
  "config/studiobrain/systemd/studio-brain-idle-worker.timer.d/10-cadence.conf",
  "config/studiobrain/systemd/studio-brain-idle-worker-overnight.service",
  "config/studiobrain/systemd/studio-brain-idle-worker-overnight.service.d/20-clean-lane.conf",
  "config/studiobrain/systemd/studio-brain-idle-worker-overnight.timer",
  "config/studiobrain/systemd/studio-brain-idle-worker.sh",
  "config/studiobrain/systemd/studio-brain-ops-capture.service",
  "config/studiobrain/systemd/studio-brain-ops-capture.timer",
  "config/studiobrain/sudoers/studio-brain-ops-capture",
  "scripts/studiobrain-idle-worker-effectivity-audit.mjs",
