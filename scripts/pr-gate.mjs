...
const REQUIRED_NODE_ENTRYPOINTS = [
  ...
  "scripts/studiobrain-proxy-bundle.mjs",
  "scripts/check-agent-surfaces.mjs",
  "studio-brain/docker-compose.proxy.yml",
  "studio-brain/docker/Caddyfile.proxy",
...
const steps = [
  ...
  },
  {
    ...
    remediation: "Regenerate contract docs with `npm run docs:contract` and commit the generated artifact.",
    required: true,
  },
  {
  ...
  },
  {
    ...
    remediation: "Run `npm run backup:verify` to create a fresh manifest, then rerun backup freshness checks.",
    required: false,
  },
];
