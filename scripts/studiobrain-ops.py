...
SUPPORT_PATHS = (
    ...
    REPO_ROOT / "config" / "studiobrain" / "sudoers",
    ...
    REPO_ROOT / "scripts" / "install-studiobrain-ops-capture.sh",
    ...
    REPO_ROOT / "scripts" / "ops" / "privileged_evidence_capture.sh",
    REPO_ROOT / "scripts" / "ops" / "privileged_evidence_read.sh",
