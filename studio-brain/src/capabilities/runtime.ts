...
export const defaultCapabilities: CapabilityDefinition[] = [
  ...
  {
    id: "support.billing.adjustment",
    target: "firestore",
    description: "Create an approval-gated proposal for billing adjustments, refunds, or fee exceptions from support.",
    readOnly: false,
    requiresApproval: true,
    maxCallsPerHour: 12,
    risk: "high",
  ...
  {
    id: "support.reservation.override",
    target: "firestore",
    description: "Create an approval-gated proposal for reservation or schedule overrides from support.",
    readOnly: false,
    requiresApproval: true,
    maxCallsPerHour: 12,
    risk: "high",
  ...
  {
    id: "support.queue.override",
    target: "firestore",
    description: "Create an approval-gated proposal for queue, deadline, or priority-change requests from support.",
    readOnly: false,
    requiresApproval: true,
    maxCallsPerHour: 12,
    risk: "high",
  ...
  {
    id: "support.access.exception",
    target: "firestore",
    description: "Create an approval-gated proposal for support-driven access exceptions or credential handling.",
    readOnly: false,
    requiresApproval: true,
    maxCallsPerHour: 8,
    risk: "critical",
