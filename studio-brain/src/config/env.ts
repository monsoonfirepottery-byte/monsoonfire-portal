...
const EnvSchema = z.object({
  ...
  STUDIO_BRAIN_OPENAI_DEFAULT_MODEL: z.string().default("gpt-5.4-mini"),
  ...
  STUDIO_BRAIN_OLLAMA_MAX_OUTPUT_TOKENS: z.coerce.number().int().min(16).max(4_096).default(512),
  STUDIO_BRAIN_OLLAMA_NUM_THREAD: z.coerce.number().int().min(1).max(64).default(2),
  ...
  STUDIO_BRAIN_LOCAL_ORCHESTRATOR_INTERVAL_MS: z.coerce.number().int().min(60_000).max(86_400_000).default(15 * 60 * 1000),
  STUDIO_BRAIN_LOCAL_ORCHESTRATOR_INITIAL_DELAY_MS: z.coerce.number().int().min(0).max(300_000).default(30_000),
