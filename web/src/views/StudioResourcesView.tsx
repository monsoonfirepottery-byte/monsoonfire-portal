      ...
      <section className="card card-3d studio-resources-hero">
        ...
        <div className="studio-resources-hero-panel">
          ...
          <ul className="studio-resources-panel-list">
            <li>Reserve shared studio time before you commute in.</li>
