...
const FALLBACK_FAQ_ENTRIES: FaqEntry[] = [
  ...
  },
  {
    ...
    question: "What is happening to membership?",
    answer:
      "Membership is being decommissioned during May 2026 and reaches end-of-life on May 31, 2026. Submit a support request for billing, archive, or transition help.",
    category: "Membership",
    tags: ["membership", "decommission", "eol", "transition"],
    rank: 3,
  ...
  {
    id: "fallback-firing-credit",
    question: "What happens if there is a studio firing mistake?",
    answer:
      "If review shows the issue was studio-side, we route it through our generous firing-credit review path. Include your batch ID, firing type, and photos so staff can review quickly.",
    category: "Kiln",
    tags: ["kiln", "credit", "billing", "damage", "support"],
    rank: 4,
    policySlug: "damage-responsibility",
  ...
  },
  {
    ...
    answer:
      "Open Support and request a continuity export if you need a full JSON/CSV archive of legacy reservation records. Your piece history remains visible in My Pieces while your account stays active.",
    category: "Account",
...
const SEARCH_SYNONYMS: Record<string, string[]> = {
  ...
  credit: ["refund", "billing", "charge", "damage"],
  receipt: ["invoice", "billing"],
  refund: ["credit", "billing", "charge"],
  membership: ["decommission", "eol", "transition"],
