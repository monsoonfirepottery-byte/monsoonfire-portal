...
superseded_by: []
related_pages: []
export_hash: 99cf215c7bf74d72cde473743c69aa7ffe9d1d6e1e3aca9264aefbe5c02e3909
---
...
| Refresh Studio Brain wiki context pack | ready | 0.65 | true | `output/wiki/context-check.json` | verified=0, warnings=11, total_warning_items=263, unverified=263, active_contradictions=0 |
| Review wiki claim extraction coverage | ready | 0.6 | true | `output/wiki/extract-check.json` | claims=263, human_approval=21, operational_truth=0 |
| Refresh wiki source index and chunk inventory | ready | 0.55 | true | `output/wiki/source-index-check.json` | sources=1613, chunks=11054 |
